      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="form-outline mb-4">
          ...
          <input
            ...
            {...register("kanji")}
          />
          <p className="text-danger fst-italic">{errors.kanji?.message}</p>
          ...
          <input
            ...
            {...register("spelling")}
          />
          <p className="text-danger fst-italic">{errors.spelling?.message}</p>
          ...
          <input
            ...
            {...register("strokes")}
          />
          <p className="text-danger fst-italic">{errors.strokes?.message}</p>
          ...
          <input
            ...
            {...register("examples")}
          />
          <p className="text-danger fst-italic">{errors.examples?.message}</p>
            ...
            <div>
              ...
              >
                <div className="card-body">
                  ...
                  <p className="card-text">Add some Kanji to be displayed</p>
                </div>
              </div>
