...
export const ProfileView = () => {
    ...
    const updateProfilePicture = async () => {
        ...
        await axios.post("/api/users/setpp", {'pp': profilePicture}, {
            headers: {
                            ...
                            <div className="modal-dialog">
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <button type="button" className="btn btn-dark btn-lg btn-block mt-2" onClick={updateProfilePicture} aria-label="Close">Save</button>
                                    </div>
                                </div>
                            </div>
                        </div>
